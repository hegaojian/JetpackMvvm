...
import me.hgj.mvvm_nb_demo.adapter.SystemAdapter
...
class SystemFragment:BaseFragment<TreeViewModel,IncludeListBinding>(){
    ...
    private val systemAdapter : SystemAdapter by lazy { SystemAdapter(arrayListOf()).apply {
    ...
    override fun createObserver() {
        mViewModel.systemDataState.observe(this, Observer {
